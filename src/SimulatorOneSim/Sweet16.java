...
public class Sweet16 {
	 private double min = -500.0000;
	    private double max = 500.0000;
	    ...
	    public Sweet16(String topTeamName, double topTeamScore, String bottomTeamName, double bottomTeamScore){
